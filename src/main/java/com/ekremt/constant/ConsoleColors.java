package com.ekremt.constant;

/**
 * ConsoleColors sınıfı, konsol uygulamalarında metin renklerini ayarlamak için ANSI escape kodlarını içeren bir utility sınıfıdır:
 */
